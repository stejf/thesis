...
#Plots
rm(list=ls())
setwd('C:/Users/Steve/OneDrive - Imperial College London/MSc/Summer Project/R Code/Huang d_300/alldir_hard')
load("pvalues.RData")
...
p = ggplot() + stat_ecdf(dat=pvals, aes(x=pvalue, linetype=a, colour=a)) + 
  ...
  ggtitle("Hard Method (Mixture 2 Gauss. - All Directions)") +
