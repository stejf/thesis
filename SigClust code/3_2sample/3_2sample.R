...
#Plots
rm(list=ls())
setwd('C:/Users/Steve/OneDrive - Imperial College London/MSc/Summer Project/R Code/Huang d_300/3_2sample')
load("pvalues.RData")
...
p = ggplot() + stat_ecdf(dat=pvals, aes(x=pvalue, linetype=a, colour=a)) + 
  ...
  ggtitle("Mixture of Gaussians - Signal in 1 Direction (sample)") +
